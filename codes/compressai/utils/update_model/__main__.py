...
def setup_args():
    ...
    parser.add_argument("-checkpoint", "--checkpoint", type=str, required=True, help="Checkpoint")
...
def main(argv):
    ...
    filepath = os.path.join('../experiments', args.experiment, 'checkpoints', args.checkpoint)
    print(filepath)
