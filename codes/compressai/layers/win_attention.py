...
"""WAM.
    ...
    Introduced in `"The Devil Is in the Details: Window-based Attention for Image Compression" 
    <https://arxiv.org/abs/2203.08450>`_,
    by Renjie Zou, Chunfeng Song, Zhaoxiang Zhang (2022)."""
